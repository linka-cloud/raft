[![GoDoc](https://godoc.org/go.linka.cloud/raft?status.svg)](https://pkg.go.dev/go.linka.cloud/raft)
[![Go Report Card](https://goreportcard.com/badge/go.linka.cloud/raft)](https://goreportcard.com/report/go.linka.cloud/raft)
...
## Examples and dcos 
 - More detailed development documentation can be found in [go docs](https://pkg.go.dev/go.linka.cloud/raft)
