...
func (l *wal) AddEntries(ctx context.Context, entries []raftpb.Entry) error {
	ctx, tr := trace.NewTask(ctx, "raftwal.wal.addEntries")
	defer tr.End()
	...
	for _, re := range entries {
		...
		AssertTrue(copy(destBuf, re.Data) == len(re.Data))
