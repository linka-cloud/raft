...
import (
	...
	raft "github.com/shaj13/raft/vendor/go.etcd.io/raft/v3"
...
func (mr *MockNodeMockRecorder) ForgetLeader(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForgetLeader", reflect.TypeOf((*MockNode)(nil).ForgetLeader), ctx)
}
